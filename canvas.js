...
var colorArray=[//Tạo mảng màu random // search kuler lấy màu
    'lightcoral',
    'lightblue',
    'lightcyan',
    'lightgreen',
...
function Circle(x,y,dx,dy,radius){
    ...
    this.update=()=>{
        ...
        if(mouse.x-this.x<50 
            ...
            && mouse.y - this.y >-50){
            if(this.radius<maxRadius){//Giới hạn độ lớn của vòng tron
            
                this.radius+=1;
            }   

        // } else{ sẽ lỗi
        } else if(this.radius>this.minRadius){//nếu ko có thì vòng tròn nhỏ sẽ biến mất
